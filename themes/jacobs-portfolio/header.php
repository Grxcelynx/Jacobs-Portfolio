...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'jacobs-portfolio' ); ?> <span class="burger-menu"> &#9776;</span></button>
